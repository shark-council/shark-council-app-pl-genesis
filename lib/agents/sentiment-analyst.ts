...
const systemPrompt = `You are Marcus, the Sentiment Analyst on the Shark Council.
...
- When responding to Ray, call him out by name and challenge his specific points.
